...
public class Hbasedome implements HBaseDemoInterface {
    ...
    private static final String ZKconnect="hadoopnode2:2181";
    static{
...
//  static String[] family={"lie01","lie02"};
    ...
    public static void main(String[] args) {
        ...
        String[] family={"basic_characteristics","nternet_usage_habits"
        ,"product_usage_habits","other_characteristics","objective",
                "preference","demand","scene","frequency"};
...
//          a.dropTable("user1");
//          a.getAllTables();
          a.putData("user_portrait", "r91", "basic_characteristics", "age", "liu======");
//          a.getResult("table03", "usr001");
//          a.getResultScann("table03");
//          a.getResultScann("table03","");

            Result result = a.getResult("user_portrait", "r91");
